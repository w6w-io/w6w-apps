...
/** `deleteTableRow` — delete a row identified by any cell in it. */
const documentDeleteTableRow: ActionDefinition<Input> = {
  key: "document-delete-table-row",
  type: "perform",
  resource: "document",
  title: "Delete Table Row",
  description: "Delete the row containing the given cell.",
  params: [
...
export default documentDeleteTableRow;
