...
export const organizationId: Param = {
  ...
  type: "string",
  hint: "Zoho Books organization id. Falls back to the one recorded when this connection was " +
...
export const statusOutput = [
  { key: "code", type: "number" as const, label: "Zoho Books result code (0 = success)" },
