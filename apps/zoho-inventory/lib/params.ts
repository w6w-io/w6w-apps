...
export const organizationId: Param = {
  ...
  type: "string",
  hint: "Zoho Inventory organization id. Falls back to the one recorded when this connection was " +
...
export const recordId: Param = {
  ...
  type: "string",
  required: true,
  hint: "The Zoho Inventory record id.",
};
...
export const statusOutput = [
  { key: "code", type: "number" as const, label: "Zoho Inventory result code (0 = success)" },
