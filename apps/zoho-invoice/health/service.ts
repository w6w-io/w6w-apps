/**
 * Is Zoho Invoice up? — Zoho's StatusIQ (Site24x7) status page.
 *
 * Verified 2026-09-01: `https://us.zohostatus.com/rss` is a Site24x7 StatusIQ
 ...
 * live: the entry is exactly `"Zoho Invoice - Operational"`, distinct from
 * the generic "Zoho" umbrella entries and from the "Zoho Books" entry also
 * on the same page. This is the same feed this pack's `zoho` (Zoho CRM),
 ...
 *     this hook only finds the "Zoho Invoice" component and reads its status
...
/** Exact component name on the status page — "Zoho Invoice". */
const COMPONENT = "Zoho Invoice";

const service: HealthCheckDefinition = {
  key: "service",
  title: "Zoho Invoice platform status",
  description:
    'Reads the "Zoho Invoice" component off Zoho\'s StatusIQ RSS feed (us.zohostatus.com/rss). ' +
