...
Deno.test("oauth2-us: sign stamps the Zoho-oauthtoken header and nothing else", () => {
  ...
  const request = {
    method: "GET",
    url: "https://www.zohoapis.com/invoice/v3/organizations",
    headers: {},
  };
  ...
  assertEquals(signed.url, "https://www.zohoapis.com/invoice/v3/organizations");
...
/**
 * Zoho Invoice's two documented codes are two different problems: no usable
